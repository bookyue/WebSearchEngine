...
#  -l Optional. Location of the default user workspace at Hadoop where Project1 was added, e.g. /user/hadoop. This is because sudo access moves the current directory to /. Not required if spark does not require sudo access.
